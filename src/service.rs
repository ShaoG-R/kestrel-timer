use lite_sync::{oneshot::lite::{channel, Sender, Receiver}, spsc};
...
impl ServiceActor {
    ...
    /// 
    /// 创建新的 ServiceActor
    fn new(command_rx: spsc::Receiver<ServiceCommand, 32>, timeout_tx: spsc::Sender<TaskNotification, 32>, shutdown_rx: Receiver<()>) -> Self {
        Self {
            command_rx,
            timeout_tx,
            shutdown_rx,
